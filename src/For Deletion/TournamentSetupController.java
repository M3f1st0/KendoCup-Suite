...
//            
//            if(tournament.checkDuplicateCup(cup)){
//                //add the cup in the tournament object
//                tournament.addCup(cup);
//                
...
//            }else{
//                DataStorage.getInstance().msgBox("The Competiton already exists in the tournament.", false);
//            }
//            
////        try {
////            String cupName = cupNameTxt.getText().trim().toUpperCase();
...
////                int shiaijosnum = Integer.parseInt(shiaijoTxt.getText());
////                boolean teamCheckBoxChecked = isATeamChkBx.selectedProperty().get();
////                submitFirstTitledPaneDataToCupsArray(cupName, poolNumber, pPlayers, mPlayers, shiaijosnum, teamCheckBoxChecked);
////
...
//        }
//
//        //if the data are already saved enable all the title panes and disable the buttons that alter the tournament
//        if (tournament.isIsTournamentSetUpCompleted()) {
